...
public class App {  
    ...
    public static void main(String[] args) {
        ...
        Etudiant etudiant4 = new Etudiant("Fatima", "IDBRAHIM", "1400002357", equipe2);
        Etudiant etudiant5 = new Etudiant("Aicha","Alami", "1400002358",    equipe2);   
        Etudiant etudiant6 = new Etudiant("Hicham", "Smahi", "1400002359",  equipe2);
        ...
        System.out.println("--------------------------------------------------");
        //Affichage deatails équipes boucle for
